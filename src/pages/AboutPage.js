  ...
  return (
    ...
    >
      <section className="sectionAboutTeam">
        ...
        <div className="container">
          <h1 className="sectionAboutTitle">
            At Traverse Labs, we build applications that unlock new capabilities
            for blockchain users to manage and interact with their holdings. We
            are currently developing our first product: the Traverse Dashboard
          </h1>
      ...
      <section className="sectionAboutAccordion">
        <div className="container">
          <h2 className="sectionAboutAccordionTitle">More About Traverse</h2>

          <Accordion list={aboutAccordion} />
        </div>
      </section>
    </PageLayout>
  );
