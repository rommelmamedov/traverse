import {
  walletManagementAccordion,
  walletManagementFeatureCards,
...
function HomePageTabWalletManagement() {
  return (
    <section className="sectionTab sectionTabWalletManagement">
      <section className="sectionFeatures">
        <div className="container">
          <h2 className="sectionFeaturesTitle">
            Traverse is a wallet management dashboard that allows you to view,
            manage, and secure all your tokens in one place
          </h2>
      ...
      <section className="sectionFaqs">
        <div className="container">
          <h2 className="sectionFaqsTitle">About our wallet management</h2>

          <Accordion list={walletManagementAccordion} />
        </div>
      </section>
    </section>
  );
